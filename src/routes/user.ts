...
import { getAllUsers, toggleUserStatus, deleteUser } from '../controllers/userControllers.js';
...
router.delete('/', authenticateToken, checkPermission('manage_users'), deleteUser as any);
