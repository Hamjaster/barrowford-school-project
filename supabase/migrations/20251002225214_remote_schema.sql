...
ALTER TABLE "public"."parent_student_relationship" OWNER TO "postgres";


ALTER TABLE "public"."parent_student_relationship" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
ALTER TABLE ONLY "public"."parent_student_relationship"
...
CREATE INDEX "idx_parent_student_relationship_parent" ON "public"."parent_student_relationship" USING "btree" ("parent_id");



CREATE INDEX "idx_parent_student_relationship_student" ON "public"."parent_student_relationship" USING "btree" ("student_id");
...
GRANT ALL ON TABLE "public"."parent_student_relationship" TO "anon";
GRANT ALL ON TABLE "public"."parent_student_relationship" TO "authenticated";
GRANT ALL ON TABLE "public"."parent_student_relationship" TO "service_role";
